/*
  ...
  Currently a curated 25-node subset (the same one the design reference uses):
  seven roots, deep decimal nesting, a terminal proposition 7. The full ~525
  statements replace this file later without any shape change.

  `refs` are Wittgenstein-style cross-references to other statements by id
